...
from locust.contrib.fasthttp import FastHttpSession, _construct_basic_auth_str
...
class TestFastHttpUserClass(WebserverTestCase):
    ...
    def test_client_basic_auth_credentials_are_unquoted(self):
        ...
        self.assertEqual(_construct_basic_auth_str("locust", "p@ss/word"), locust.client.auth_header)
